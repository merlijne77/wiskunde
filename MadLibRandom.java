/**
 * www.programmmingbydoing.com for whole assignment.
 * assignment made by @author hdziedzic
 */
...
public class MadLibRandom {
	...
	public static void main(String[] args)
	{
		...
		System.out.printf("\"Don't be such a(n) %s! We're going in. I think it looks " + adver + "\n", noun2 );
